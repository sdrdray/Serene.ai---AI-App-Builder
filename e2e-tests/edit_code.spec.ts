...
test("edit code", async ({ po }) => {
  const editedFilePath = path.join("src", "components", "made-with-serene.tsx");
  ...
  await po.page.getByText("made-with-serene.tsx").click();
  await po.page
    .getByRole("code")
    .locator("div")
  ...
  await po.page
    ...
    .fill("export const MadeWithSerene = ;");
  ...
  expect(editedFile).toContain("export const MadeWithSerene = ;");
});
