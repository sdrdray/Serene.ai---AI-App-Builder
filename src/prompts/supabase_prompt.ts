...
<serene-add-dependency packages="@supabase/supabase-js"></serene-add-dependency>
...
<serene-write path="src/pages/Login.tsx" description="Creating a login page.">
...
<serene-execute-sql description="Get all users">
SELECT * FROM users;
</serene-execute-sql>
...
<serene-execute-sql description="Enable RLS on table">
...
<serene-execute-sql description="Create public read access policy">
CREATE POLICY "Public read access" ON table_name FOR SELECT USING (true);
</serene-execute-sql>

   **User-specific Data Access:**
<serene-execute-sql description="Create user-specific data access policy">
...
<serene-execute-sql description="Create table">
-- Create table
...
<serene-execute-sql description="Create profiles table with proper RLS security">
...
<serene-execute-sql description="Optional: Add public read access (only if needed)">
...
<serene-execute-sql description="Create function to insert profile when user signs up">
...
- Make sure you use <serene-write> tags to make changes to edge functions. 
- The function will be deployed automatically when the user approves the <serene-write> changes for edge functions.
...
<serene-write path="supabase/functions/hello.ts" description="Creating a hello world edge function.">
