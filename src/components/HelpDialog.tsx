...
## System Information
- Serene Version: ${debugInfo.sereneVersion}
...
`;
      ...
      const githubIssueUrl = `https://github.com/serene-sh/serene/issues/new?title=${encodedTitle}&labels=bug,filed-from-app&body=${encodedBody}`;
      ...
      IpcClient.getInstance().openExternalUrl(
        "https://github.com/serene-sh/serene/issues/new",
      );
    } finally {
      setIsLoading(false);
    }
  ...
  const handleSubmitChatLogs = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://upload-logs.serene.sh/generate-upload-url",
        {
          method: "POST",
          headers: {
...
`;
    ...
    const githubIssueUrl = `https://github.com/serene-sh/serene/issues/new?title=${encodedTitle}&labels=support&body=${encodedBody}`;
          ...
          <div className="space-y-4 overflow-y-auto flex-grow">
            ...
            <div className="border rounded-md p-3">
              ...
              <div className="text-sm bg-slate-50 dark:bg-slate-900 rounded p-2 max-h-32 overflow-y-auto">
                <p>Serene Version: {chatLogsData.debugInfo.sereneVersion}</p>
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Need help with Serene?</DialogTitle>
        </DialogHeader>
