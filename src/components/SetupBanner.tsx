  ...
  return (
    <>
      <p className="text-xl text-zinc-700 dark:text-zinc-300 p-4">
        Follow these steps and you'll be ready to start building with Serene...
      </p>
    ...
    <div className="mt-3 p-3 bg-(--background-lighter) border rounded-lg text-sm">
      <p>
        ...
        <a
          onClick={() => {
            IpcClient.getInstance().openExternalUrl(
              "https://www.serene.sh/docs/help/nodejs",
            );
          }}
    ...
    case "finished-checking":
      return (
        <div className="mt-3 text-sm text-red-600 dark:text-red-400">
          Node.js not detected. Closing and re-opening Serene usually fixes this.
        </div>
      );
    default:
