...
export const TURBO_EDITS_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    { type: "link", content: " Get Serene Pro", url: "https://serene.sh/pro#ai" },
...
export const SMART_CONTEXT_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: "Serene Pro's Smart Context",
      url: "https://serene.sh/pro#ai",
    },
  ],
};
...
export const REDDIT_TIP: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: "Serene subreddit",
      url: "https://www.reddit.com/r/serenebuilders/",
    },
  ],
};
...
export const BUILD_A_BIBLE_APP_TIP: MessageConfig = {
  spans: [
    ...
    {
      type: "text",
      content: " the creator of Serene build a Bible app step-by-step",
    },
  ],
};
...
export const DEBUGGING_TIPS_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      ...
      url: "https://www.serene.sh/docs/guides/debugging",
    },
  ],
};

// Advanced tip: Customize your AI rules https://www.serene.sh/docs/guides/ai-rules
export const AI_RULES_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "AI rules",
      url: "https://www.serene.sh/docs/guides/ai-rules",
    },
  ],
};
...
// Want to know what's next? Checkout our roadmap https://www.serene.sh/docs/roadmap
export const ROADMAP_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "roadmap",
      url: "https://www.serene.sh/docs/roadmap",
    },
  ],
};

// Like Serene? Star it on GitHub https://github.com/serene-sh/serene/
export const GITHUB_TIP: MessageConfig = {
  spans: [
    {
      type: "text",
      content: "Like Serene? Star it on ",
    },
    {
      type: "link",
      content: "GitHub",
      url: "https://github.com/serene-sh/serene",
    },
  ],
};
