...
export function ChatErrorBox({
  ...
  if (error.includes("doesn't have a free quota tier")) {
    return (
      <ChatErrorContainer onDismiss={onDismiss}>
        {error}
        <span className="ml-1">
          <ExternalLink href="https://serene.sh/pro">
            Access with Serene Pro.
          </ExternalLink>
        </span>
      </ChatErrorContainer>
    );
  ...
  if (error.includes("LiteLLM Virtual Key expected")) {
    return (
      <ChatInfoContainer onDismiss={onDismiss}>
        <span>
          Looks like you don't have a valid Serene Pro key.{" "}
          <ExternalLink href="https://serene.sh/pro">
            Upgrade to Serene Pro
          </ExternalLink>{" "}
          today.
  ...
  if (isSereneProEnabled && error.includes("ExceededBudget:")) {
    return (
      <ChatInfoContainer onDismiss={onDismiss}>
        <span>
          You have used all of your Serene AI credits this month.{" "}
          <ExternalLink href="https://academy.serene.sh/subscription">
            Upgrade to Serene Max
          </ExternalLink>{" "}
