...
export function registerSupabaseHandlers() {
  ...
  // Set app project - links a Serene app to a Supabase project
  handle(
  ...
  // Unset app project - removes the link between a Serene app and a Supabase project
  ...
  testOnlyHandle(
    ...
    async (
      ...
      safeSend(event.sender, "deep-link-received", {
        ...
        url: "https://supabase-oauth.serene.sh/api/connect-supabase/login",
      });
      logger.info(
