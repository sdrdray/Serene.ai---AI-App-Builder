...
export const SereneProBudgetSchema = z.object({
  budgetResetAt: z.string(),
  maxBudget: z.number(),
});
export type SereneProBudget = z.infer<typeof SereneProBudgetSchema>;
...
export const UserSettingsSchema = z.object({
  ...
  enableSerenePro: z.boolean().optional(),
  ...
  sereneProBudget: SereneProBudgetSchema.optional(),
...
export function isSereneProEnabled(settings: UserSettings): boolean {
  return settings.enableSerenePro === true && hasSereneProKey(settings);
}

export function hasSereneProKey(settings: UserSettings): boolean {
